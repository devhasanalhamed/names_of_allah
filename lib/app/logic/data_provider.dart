...
class DataProvider with ChangeNotifier {
  ...
  static final List<NameModel> _namesOfAllah = [
//الأسماء الواردة في القران
    ...
    //   name: 'الغفار',
    //   meaning:
    //       'مأخوذ من الغفرِ وهو التغطية فهو سبحانه كثير الستر والتجاوز عن ذنوب عباده وزلاتهم',
    //   search: 'الغفار',
    //   favorite: false,
    // ),
    // Names(
    ...
    //   meaning:
    //       'هما من الأسماء المزدوجة المتقابلة التي لا يطلق واحد بمفرده على الله إلا مقرونا بالآخر؛ الذي يقدم من يشاء، ويؤخر من يشاء من مخلوقاته؛ في الخلق، والرزق، والفضل؛ فخلق بني آدم وفضلهم على كثير ممن خلق، وأخر آخرين من مخلوقاته، وفضل الأنبياء وقدمهم على الخلق، وفضل بعضهم على بعض، وقدم بعض عباده ورفع بعضهم فوق بعض درجات، وأخر آخرين؛ كل ذلك بفضله وعدله وحكمته سبحانه',
    //   search: 'المقدم و المؤخر',
    //   favorite: false,
    // ),
  ];

  List<NameModel> _finalList = _namesOfAllah;

  List<NameModel> get namesOfAllah {
    return [..._finalList];
  }
  ...
  NameModel returnName(int index) {
